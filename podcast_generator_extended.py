...
Version 5.2 - Extended Duration Version
"""
        ...
        try:
            ...
            if self.voice_clone_audio and self.voice_clone_transcript:
                ...
                output = self.tts_model.generate(
                    ...
                    top_p=0.92,
                    cfg_filter_top_k=40,
                    max_tokens=10000  # Increased from 2500
                )
            else:
            ...
            print(f"  Duration: {len(audio_data) / sample_rate:.1f} seconds ({len(audio_data) / sample_rate / 60:.1f} minutes)")
